    ...
    return (
        <div className="d-flex" dir='ltr' style={{ justifyContent: "center", alignItems: "center", }}>
            ...
            <Container md='8' style={{ width: "400px" }}>
                ...
                <Card.Body >
                    <center style={{ padding: "10px" }}>
                        ...
                        <Container>
                            <div className='row' style={{ paddingBottom: "10px", textAlign: "right" }}>
                                ...
                                <TextField placeholder={t('Confirm password')} style={{ borderRadius: ".375rem", paddingBottom: "10px" }}></TextField>

                                <Link to="/LoginPage" style={{ color: "black", textDecoration: "none", fontSize: "10px", fontWeight: "bold" }} >{t("Already have an account?")}</Link>
                            </div>
                            <div >
                                <motion.div
                                ...
                                >
                                    <button style={{
                                        borderRadius: "6px",
                                        border: "0", color: "white", width: "100%", background: "none", height: "30px",
                                    }} > {t("Register")}</button></motion.div>
                    ...
                    <Container >
                        ...
                        <Link to={"/SignUpUsingPhone"} style={{ color: "#02bcea", textDecoration: "none", fontSize: "small" }} ><AiOutlineArrowRight />{t("Signup using Mobile")}</Link>
                    </Container>
                </Card.Body>
            ...
            <div className='background2'>
                <h1 style={{
                    fontFamily: "Poppins", color: "white", position: "absolute", left: "auto", right: rightPad,
                    bottom: "50%"
                }}>{t("Creating Magic")}</h1>
